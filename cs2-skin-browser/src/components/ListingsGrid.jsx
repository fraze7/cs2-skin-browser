...
export default function ListingsGrid({ listings, total, loading, error, search, watchlist, onWatch }) {
  if (error) {
    return (
  ...
  if (!listings.length) {
    return (
      <div className="status-msg">
        {search
          ? <>No listings match <strong>"{search}"</strong>. Try a different search or select a weapon.</>
